            ...
            <div className="container px-5 py-10 mx-auto text-center lg:px-40">
                ...
                <div className="flex flex-col lg:flex-row justify-center">
                    <a href="https://github.com/arung-agamani"
                        className="mx-auto lg:mx-4 my-4 px-8 py-10 w-full max-w-sm border-4 border-gray-800 hover:bg-gray-800 transition-all bg-gray-900/50"
                    >
                        <div className="">
                            <div>
                    ...
                    >
                        <div>
                            <div>
                                <img className="block mx-auto mb-2" src={emailLogo} alt="email logo" style={{ width: 'auto', height:'120px'}}/>
                            </div>
                    ...
                    >
                        <div>
                            <div>
                                <img className="block mx-auto mb-2" src={linkedInLogo} alt="linkedin logo" style={{ width: 'auto', height:'120px'}}/>
                            </div>
                            <h1 className='text-lg font-medium text-white mb-3'>LinkedIn</h1>
                            <p className="leading-relaxed">Let's connect!</p>
                        </div>
                    </a>
                </div>
            </div>
